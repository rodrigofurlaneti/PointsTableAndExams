# Architecture & Testing Patterns — PointsTableAndExams
...
```
/
├── 1-Sql/                          # DDL scripts and seed data
...
└── 3-BackEnd/
    ├── src/
    │   ├── PointsTableAndExams.Domain          # Entities, Value Objects, Interfaces, Events
    │   ├── PointsTableAndExams.Application     # CQRS commands/queries, validators, DTOs
    │   ├── PointsTableAndExams.Infrastructure  # EF Core, repositories, JWT, Gemini, Serilog
    │   └── PointsTableAndExams.Api             # Controllers, middleware, DI composition
    └── tests/
        └── PointsTableAndExams.BddTests        # BDD/Gherkin feature files + step definitions
```
